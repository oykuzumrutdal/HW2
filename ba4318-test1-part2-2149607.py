...
print("Daily average temperature for Brazil and Madrid")
print(dffinal)

correlation= dffinal['Brazil Temperature'].corr(dffinal['Madrid Temperature'])
print("Correlation between the data is:")
print(correlation)

##BONUS: The correlation coefficient of -0.31 shows us that there is a moderate correlation between Brazil's and Madrid's temperatures.
#Oyku Zumrutdal 2149607